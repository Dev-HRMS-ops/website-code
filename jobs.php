...
<body id="header" class="jobs-page">
    ...
    <div class="header-banner">
        ...
        <div id="mainNav" class="sticky-top">
                            ...
                            <div class="offcanvas offcanvas-end  w-100" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                                ...
                                <div class="offcanvas-body">
                                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                        ...
                                        <!-- <li class="nav-item">
                                            <a class="nav-link text-uppercase border-end" href="#">NUP</a>
                                        </li> -->
                                        <li class="nav-item">
            ...
            <div class="bottom-nav container-fluid p-0">
                                        ...
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown5">
                                                    ...
                                                    <li><a class="dropdown-item text-capitalize fs-5" href="internship/index.php">Internship</a></li>
                                            ...
                                            <!-- <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle text-capitalize fs-5" href="#" id="navbarDropdown7" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                    About Us
                                                </a>
                                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown7">
                                                    <li><a class="dropdown-item text-capitalize fs-5" href="alumni.php">Alumni</a></li>
                                                    <li><a class="dropdown-item text-capitalize fs-5" href="role-and-responsiblities.php">Functions/Roles and Responsibility</a></li>
                                                </ul>
                                            </li> -->
                                        </ul>
                                    </div>
        ...
        <div class="container mt-3" id="job-section-container">
                ...
                <div class="col-10 col-md-8">
                    <div class="job-glass-card p-4 shadow-lg">
                        ...
                        <!-- <div class="job-listing mb-3 p-3 rounded-4">
                            ...
                            <p>Interview Call up letters to shortlisted candidates issued.</p>
                            <a href="contract-emp.php" class="btn btn-outline-light rounded-pill px-4">Details</a>
