    ...
    ** Header **
    ...
    <section>
        <div class="container py-3">
            <div class="row">
                <h2 class="text-center fw-bold fs-1 section-heading">Co-curricular Activities</h2>
            </div>
        </div>
    </section>
    ...
    <section class="py-5 bg-clrd-sec">
        <div class="container text-center">
            <div class="row">
                <h2 class="text-center fw-bold fs-2 section-heading">Zonal Level Competitions (2024)</h2>
            </div>
    ...
    <section class="py-5">
        <div class="container text-center">
            <div class="row">
                <h2 class="text-center fw-bold fs-2 section-heading">Co-curricular Activities at Wah Region (2024)</h2>
            </div>
    ...
    <section class="py-5 bg-clrd-sec">
        <div class="container text-center">
            <div class="row">
                <h2 class="text-center fw-bold fs-2 section-heading">Sports GALA at Bahawalpur Region (2024)</h2>
            </div>
    ...
    <section class="py-5">
        <div class="container text-center">
            <div class="row">
                <h2 class="text-center fw-bold fs-2 section-heading">Inter schools ECA/CCA Lahore Region (2024)</h2>
            </div>
    ...
    <section class="py-5 bg-clrd-sec">
        <div class="container text-center">
            <div class="row">
                <h2 class="text-center fw-bold fs-2 section-heading">Declamation Competition (Primary & High) Peshawar Region (2024)</h2>
            </div>
    ...
    <section class="py-5 bg-clrd-sec">
        <div class="container text-center">
            <div class="row">
                <h2 class="text-center fw-bold fs-2 section-heading">Co-curricular Activities Rawalpindi Region (2024)</h2>
            </div>
    ...
    <section class="py-5">
        <div class="container text-center">
            <div class="row">
                <h2 class="text-center fw-bold fs-2 section-heading">Sports and Science Projects Competitions Gujranwala Region (2024)</h2>
            </div>
