...
$News = $database->query1('select * from news order by News_Id DESC');

$achievements = $database->query1('select * from achievements order by id DESC');


$UserCounts = $database->query1('select * from visitors where id=1');
                    ...
                    <div class="single-number d-flex justify-content-evenly m-1 p-3 border border-dark rounded-3 border-2">
                        ...
                        <div class="align-self-center">
                            <span id="counter1" class="digit-box d-block fw-bold fs-1">
                                ...
                                <?php
                                foreach ($UserCounts as $u_count) {

                                    echo $u_count["visitors"];
                                }
                                ?>
                            </span>
    ...
    <section class="bg-clrd-sec py-5">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <!-- <div class="col-md-4">
                    <div class="ratio ratio-16x9">
                        <iframe src="https://www.youtube.com/embed/zvDXkdgQdyk?si=OvcU8H4Pe-V1hok_" 
                        title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                        allowfullscreen></iframe>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="ratio ratio-16x9">
                        <iframe src="https://www.youtube.com/embed/vIslnsDLgYg?si=_PV6OBSx-qSdWIoA"
                        title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                        allowfullscreen></iframe>
                    </div>
                </div> -->
    ...
    <section class="py-5">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-md-4">
                    <div class="ratio ratio-16x9">
                        <iframe src="https://www.youtube.com/embed/qc2I1HMBE9M?si=QrLX3BUduLWhstod"
                            title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen></iframe>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content shadow rounded">
                ...
                <div class="modal-body">
                    <p>700 vacant posts of teaching staff (Secondary School Teacher: BS-17 and Trained Graduate Teacher: BS 16) published in press on 3 May 2025.</p>
                    <p><strong>Teachers will be hired on contract basis for a period of 1 x years</strong>.</p>
                    <p><strong>Eligibility Criterion</strong>.</p>
                    <p><strong>Secondary School Teacher</strong>.</p>
                    <p>Qual: 16 years education with B۔Ed</p>
                    <p>Age limit: 35 years as on 3 May 25</p>                   
                    <p><strong>Trained Graduate Teacher</strong>.</p>
                    <p>Qual: 14 years education in relevant subject (English, Urdu, Maths, Physics, Chemistry, Biology) with B۔Ed</p>
                    <p>Age limit: 33 years as on 3 May 2025</p>
                    <p>Last date to apply online: 19 May 25</p>
                    <p>Apply <a href="https://induction2025.fgei.gov.pk/" target="_blank" class="fw-bold">here</a>.</p>
                    <p>To view advertisement click <a href="pdf/finalized-advertisement.pdf" target="_blank" class="fw-bold">here</a></p>
                </div>
