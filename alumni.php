    ...
    ** Header **
    ...
    <section class="bg-clrd-sec">
        <div class="container py-3">
            <div class="row text-center mb-2">
                <h1 class="fw-bold fs-1 section-heading text-muted">ALUMNI</h1>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container py-5">
            <div class="row">
                <img alt="DG FGEIs"  src="images/alumni/alumni3.jpg" class="img-fluid">
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container py-5">
            <div class="row">
                <img alt="DG FGEIs"  src="images/alumni/alumni4.jpg" class="img-fluid">
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container py-5">
            <div class="row">
                <img alt="DG FGEIs"  src="images/alumni/alumni5.jpg" class="img-fluid">
            </div>
        </div>
    </section>
